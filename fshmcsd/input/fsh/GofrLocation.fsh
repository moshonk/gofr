...
* extension[display].extension[search][4].valueString = "Longitude|position.longitude"
...
* extension[section][1].extension[field][4].valueString = "Location.type"
* extension[section][1].extension[field][5].valueString = "Location.physicalType"
* extension[section][1].extension[field][6].valueString = "Location.partOf"
...
* extension[section][6].extension[field][1].valueString = "Location.identifier:licenceNumber"
* extension[section][6].extension[field][2].valueString = "Location.extension:licensingAuthority"
* extension[section][6].extension[field][3].valueString = "Location.extension:licenceDates"
...
* extension[section][12].extension[title].valueString = "Organization"
* extension[section][12].extension[description].valueString = "Organizations Managing This Facility"
* extension[section][12].extension[name].valueString = "Organization"
* extension[section][12].extension[resource].extension[resource].valueReference = Reference(StructureDefinition/IHE.mCSD.Organization)
...
* extension[section][12].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihe.net/fhir/StructureDefinition/IHE.mCSD.hierarchy.extension').extension.where(url='part-of').valueReference"
* extension[section][12].extension[resource].extension[column][1].extension[header].valueString = "Organization Type"
* extension[section][12].extension[resource].extension[column][1].extension[field].valueString = "extension.where(url='http://ihe.net/fhir/StructureDefinition/IHE.mCSD.hierarchy.extension').extension.where(url='hierarchy-type').valueCodeableConcept.coding"
